...
from qgis.PyQt.QtWidgets import QApplication, QCheckBox, QComboBox, QDoubleSpinBox, QFormLayout, QFrame, QGridLayout, QGroupBox, QHBoxLayout, QLabel, QPushButton, QSizePolicy, QSpacerItem, QTabWidget, QVBoxLayout, QWidget
...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.tab_parameters = QTabWidget(main_window)
        self.tab_parameters.setObjectName(_fromUtf8("tab_parameters"))
        self.tab_criteria = QWidget()
        ...
        self.gridLayout_5 = QGridLayout(self.tab_profiles)
        ...
        self.graph_plot.setFrameShape(QFrame.NoFrame)
        self.graph_plot.setFrameShadow(QFrame.Sunken)
        ...
        self.graph_plot.setRenderHints(QPainter.Antialiasing|QPainter.TextAntialiasing)
        ...
        self.verticalLayout_4 = QVBoxLayout(self.tab_plot)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.tab_thresholds = QTabWidget(self.tab_plot)
        self.tab_thresholds.setTabPosition(QTabWidget.North)
        self.tab_thresholds.setTabShape(QTabWidget.Rounded)
        self.tab_thresholds.setDocumentMode(False)
        self.tab_thresholds.setObjectName(_fromUtf8("tab_thresholds"))
        self.tab_indiff = QWidget()
        self.tab_indiff.setObjectName(_fromUtf8("tab_indiff"))
        self.gridLayout_3 = QGridLayout(self.tab_indiff)
        ...
        self.gridLayout_4 = QGridLayout(self.tab_pref)
        ...
        self.tab_veto = QWidget()
        self.tab_veto.setObjectName(_fromUtf8("tab_veto"))
        self.gridLayout_7 = QGridLayout(self.tab_veto)
        ...
        self.graph_plot2.setFrameShape(QFrame.NoFrame)
        self.graph_plot2.setFrameShadow(QFrame.Sunken)
        ...
        self.graph_plot2.setRenderHints(QPainter.Antialiasing|QPainter.TextAntialiasing)
        ...
        self.gridLayout_6 = QGridLayout(self.tab_inference)
        self.gridLayout_6.setObjectName(_fromUtf8("gridLayout_6"))
        self.group_refs = QGroupBox(self.tab_inference)
        self.group_refs.setObjectName(_fromUtf8("group_refs"))
        self.verticalLayout_3 = QVBoxLayout(self.group_refs)
        ...
        self.button_chooseassign = QPushButton(self.group_refs)
        ...
        self.button_infer = QPushButton(self.group_refs)
        ...
        self.button_show = QPushButton(self.group_refs)
        ...
        self.button_zoom = QPushButton(self.group_refs)
        ...
        self.group_options = QGroupBox(main_window)
        self.group_options.setObjectName(_fromUtf8("group_options"))
        self.verticalLayout_2 = QVBoxLayout(self.group_options)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.button_loadxmcda = QPushButton(self.group_options)
        ...
        self.button_savexmcda = QPushButton(self.group_options)
        ...
        self.group_input = QGroupBox(main_window)
        self.group_input.setObjectName(_fromUtf8("group_input"))
        self.gridLayout_9 = QGridLayout(self.group_input)
        self.gridLayout_9.setObjectName(_fromUtf8("gridLayout_9"))
        self.combo_layer = QComboBox(self.group_input)
        self.combo_layer.setObjectName(_fromUtf8("combo_layer"))
        self.gridLayout_9.addWidget(self.combo_layer, 0, 0, 1, 1)
        self.button_loadlayer = QPushButton(self.group_input)
        ...
        self.group_profiles = QGroupBox(main_window)
        self.group_profiles.setObjectName(_fromUtf8("group_profiles"))
        self.horizontalLayout_2 = QHBoxLayout(self.group_profiles)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.button_add_profile = QPushButton(self.group_profiles)
        self.button_add_profile.setEnabled(False)
        self.button_add_profile.setText(_fromUtf8(""))
        icon = QIcon()
        icon.addPixmap(QPixmap(_fromUtf8(":/plugins/etri/images/plus.svg")), QIcon.Normal, QIcon.Off)
        ...
        self.label_ncategories = QLabel(self.group_profiles)
        ...
        self.button_del_profile = QPushButton(self.group_profiles)
        self.button_del_profile.setEnabled(False)
        self.button_del_profile.setText(_fromUtf8(""))
        icon1 = QIcon()
        icon1.addPixmap(QPixmap(_fromUtf8(":/plugins/etri/images/min.svg")), QIcon.Normal, QIcon.Off)
        ...
        self.group_thresholds = QGroupBox(main_window)
        ...
        self.formLayout = QFormLayout(self.group_thresholds)
        self.formLayout.setFieldGrowthPolicy(QFormLayout.AllNonFixedFieldsGrow)
        self.formLayout.setObjectName(_fromUtf8("formLayout"))
        self.cbox_samethresholds = QCheckBox(self.group_thresholds)
        self.cbox_samethresholds.setObjectName(_fromUtf8("cbox_samethresholds"))
        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.cbox_samethresholds)
        self.cbox_noveto = QCheckBox(self.group_thresholds)
        self.cbox_noveto.setObjectName(_fromUtf8("cbox_noveto"))
        self.formLayout.setWidget(6, QFormLayout.LabelRole, self.cbox_noveto)
        self.cbox_mrsort = QCheckBox(self.group_thresholds)
        self.cbox_mrsort.setObjectName(_fromUtf8("cbox_mrsort"))
        self.formLayout.setWidget(7, QFormLayout.LabelRole, self.cbox_mrsort)
        self.right_layout.addWidget(self.group_thresholds)
        self.group_affectation = QGroupBox(main_window)
        self.group_affectation.setObjectName(_fromUtf8("group_affectation"))
        self.gridLayout_8 = QGridLayout(self.group_affectation)
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.layout_cutlevel = QHBoxLayout()
        self.layout_cutlevel.setObjectName(_fromUtf8("layout_cutlevel"))
        self.label_cutlevel = QLabel(self.group_affectation)
        self.label_cutlevel.setObjectName(_fromUtf8("label_cutlevel"))
        self.layout_cutlevel.addWidget(self.label_cutlevel)
        self.spinbox_cutlevel = QDoubleSpinBox(self.group_affectation)
        ...
        icon2 = QIcon()
        icon2.addPixmap(QPixmap(_fromUtf8(":/plugins/etri/images/etri.svg")), QIcon.Normal, QIcon.Off)
