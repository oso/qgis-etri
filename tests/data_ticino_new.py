...
criteria = criteria([ prix, transport, envir, residents, competition ])

# Actions
a1 = action('a1', 'a1', {prix: 120, transport:  284, envir: 5, residents: 3.5, competition: 18})
a2 = action('a2', 'a2', {prix: 150, transport:  269, envir: 2, residents: 4.5, competition: 24})
a3 = action('a3', 'a3', {prix: 100, transport:  413, envir: 4, residents: 5.5, competition: 17})
a4 = action('a4', 'a4', {prix:  60, transport:  596, envir: 6, residents: 8.0, competition: 20})
